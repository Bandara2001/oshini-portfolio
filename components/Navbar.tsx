    ...
    <>
      <style>{`
        ...
        .nav-bg.scrolled {
          ...
          box-shadow: 0 4px 40px rgba(0, 255, 180, 0.06);
        }
        ...
        .logo-name {
          background: linear-gradient(90deg, #ffffff 0%, #00ffc8 100%);
        ...
        .corner-tl {
          top: 10px; left: 16px;
          border-top: 1.5px solid #00ffc8;
          border-left: 1.5px solid #00ffc8;
        }

        .corner-br {
          bottom: 10px; right: 16px;
          border-bottom: 1.5px solid #00ffc8;
      ...
      <nav className="nav-root" ref={navRef}>
        <div
          className={`nav-bg ${isScrolled ? "scrolled" : "top"}`}
          style={{ "--mx": `${mouseX}%` } as React.CSSProperties}
        >
